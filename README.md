...
The brain of the pipeline. Runs [Gemma-4-26B-A4B](https://huggingface.co/unsloth/gemma-4-26B-A4B-it-GGUF?show_file_info=gemma-4-26B-A4B-it-Q8_0.gguf) (Q8_0 quantization) with [MTP speculative decoding](https://huggingface.co/unsloth/gemma-4-26B-A4B-it-GGUF?show_file_info=MTP%2Fgemma-4-26B-A4B-it-Q8_0-MTP.gguf) for significantly faster inference. Served via [llama.cpp](https://github.com/ggml-org/llama.cpp) with an OpenAI-compatible API. If you don't have the VRAM to run the 26B model, [Gemma-4-E4B-it-GGUF](https://huggingface.co/unsloth/gemma-4-E4B-it-GGUF) (Q8_0 quantization) is a solid alternative for GPUs with less memory.
